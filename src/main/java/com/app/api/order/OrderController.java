...
public class OrderController {
  ...
  public OrderResponse getOrdersByPage(
    ...
    Pageable pageable
      ...
      Order qry = new Order();
      if (orderId != null)     { qry.setId(orderId); }
      ...
      Page<Order> pg = orderRepo.findAll(org.springframework.data.domain.Example.of(qry), pageable);
  ...
  public OrderDetailResponse getOrderDetail( @RequestParam(value = "orderid", required = false) Integer orderId) {
    ...
    String sql  = " select order_id, product_id   , customer_id  , order_date, order_status  , shipped_date    , employee_id , payment_type, paid_date, "
                ...
                + " shipping_fee   , customer_first_name, customer_last_name , customer_email, company from order_details " ;
    ...
    for (Map<String, Object> row : list) {
      ...
      if (prevOrderId != newOrderId){
        ...
        orderDetail = new OrderDetail(
            ...
            (String)row.get("customer_first_name"),
            (String)row.get("customer_last_name"),
